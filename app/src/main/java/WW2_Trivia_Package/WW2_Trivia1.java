...
import WW2_Spelling_Package.WW2_Spelling2;
import functions.MinimizeFunc;

public class WW2_Trivia1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww2_trivia1);
        ...
        // Start the timer
        tick = MediaPlayer.create(WW2_Trivia1.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(WW2_Trivia1.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (answer.equals(null)) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(WW2_Trivia1.this).create();
                ...
                if (answer.equalsIgnoreCase("Japan")) {

                    // Display to the textview that the user is correct and add 1 to the score variable
                    correct = MediaPlayer.create(WW2_Trivia1.this, R.raw.correctsound);
                    correct.start();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, WW2_Trivia2.class);
