...
public class WW2_Trivia8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww2_trivia8);
        ...
        // Start the timer
        tick = MediaPlayer.create(WW2_Trivia8.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(WW2_Trivia8.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (answer.equals(null)) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(WW2_Trivia8.this).create();
                ...
                if (answer.equalsIgnoreCase("Operation Z")) {

                    // Display to the textview that th e user is correct and add 1 to the score variable
                    correct = MediaPlayer.create(WW2_Trivia8.this, R.raw.correctsound);
                    correct.start();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, WW2_Trivia9.class);
