...
import WW2_Spelling_Package.TotalScoreSpelling;
import WW2_Spelling_Package.WW2_Spelling1;
import functions.MinimizeFunction;

public class TotalScoreTrivia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_score_trivia);
        ...
        button.setOnClickListener(v -> {
            Intent intentph = new Intent(TotalScoreTrivia.this, WW2_Trivia1.class);
        ...
        button1.setOnClickListener(v -> {
            Intent intentmenu = new Intent(TotalScoreTrivia.this, Menu.class);
