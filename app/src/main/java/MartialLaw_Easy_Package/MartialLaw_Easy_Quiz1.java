...
import PhilAmericanWar_Hard_Package.PH_USA_Hard_Quiz2;
import functions.MinimizeFunc;
import functions.MinimizeFunction;

public class MartialLaw_Easy_Quiz1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_martial_law_easy_quiz1);
        ...
        // Start the timer
        tick = MediaPlayer.create(MartialLaw_Easy_Quiz1.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(MartialLaw_Easy_Quiz1.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received1++;
                correct = MediaPlayer.create(MartialLaw_Easy_Quiz1.this, R.raw.correctsound);
                correct.start();
                tick.stop();
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(MartialLaw_Easy_Quiz1.this).create();
