...
import PhilAmericanWar_Hard_Package.TotalScoreHard;
import functions.MinimizeFunction;

public class TotalScoreMartialEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_score_martial_easy);
        ...
        button.setOnClickListener(v -> {
            Intent intentph = new Intent(TotalScoreMartialEasy.this, MartialLaw_Easy_Quiz1.class);
        ...
        button1.setOnClickListener(v -> {
            Intent intentmenu = new Intent(TotalScoreMartialEasy.this, Menu.class);
