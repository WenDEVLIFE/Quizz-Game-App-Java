...
public class MartialLaw_Hard_Quiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_martial_law_hard_quiz2);
        ...
        // Start the timer
        tick = MediaPlayer.create(MartialLaw_Hard_Quiz2.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(MartialLaw_Hard_Quiz2.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received2++;
                correct = MediaPlayer.create(MartialLaw_Hard_Quiz2.this, R.raw.correctsound);
                correct.start();
                tick.stop();
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(MartialLaw_Hard_Quiz2.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, MartialLaw_Hard_Quiz3.class);
