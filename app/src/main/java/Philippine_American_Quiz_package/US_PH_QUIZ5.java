...
public class US_PH_QUIZ5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentph4 = getIntent();
        int score_received4 = intentph4.getIntExtra("score4", 0);

        // receive score from previous activity
        score_received5 = score_received4 ;

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_us_ph_quiz5);
        ...
        // Start the timer
        tick = MediaPlayer.create(US_PH_QUIZ5.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(US_PH_QUIZ5.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received5++;
                correct = MediaPlayer.create(US_PH_QUIZ5.this, R.raw.correctsound);
                correct.start();
                tick.stop();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, TotalScore_Activity1.class);
