...
public class WW2_Spelling3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww2_spelling_quiz3);
        ...
        // Start the timer
        tick = MediaPlayer.create(WW2_Spelling3.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(WW2_Spelling3.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (answer != null) {
                if (answer.equalsIgnoreCase("Bataan Death March")) {
                    ...
                    // Stop the music
                    correct = MediaPlayer.create(WW2_Spelling3.this, R.raw.correctsound);
                    correct.start();
                    // Add 1 to the score
                    score_received3++;
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(WW2_Spelling3.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, WW2_Spelling4.class);
