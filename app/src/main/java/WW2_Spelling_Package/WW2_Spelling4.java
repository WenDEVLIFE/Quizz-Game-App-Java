...
public class WW2_Spelling4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww2_spelling4);
        // Get the score from the previous page
        Intent intent = getIntent();
        score_received4 = intent.getIntExtra("score3", 0);
        ...
        // Start the timer
        tick = MediaPlayer.create(WW2_Spelling4.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(WW2_Spelling4.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (answer != null) {
                if (answer.equalsIgnoreCase("Midway")) {

                    // Stop the music
                    correct = MediaPlayer.create(WW2_Spelling4.this, R.raw.correctsound);
                    correct.start();
                    // Add 1 to the score
                    score_received4++;

                    // Display to the textview that the user is correct
                    correctText.setText("Your score is: " + score_received4);
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(WW2_Spelling4.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, WW2_Spelling5.class);
