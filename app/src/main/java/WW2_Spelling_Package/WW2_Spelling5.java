...
public class WW2_Spelling5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww2_spelling5);
        // Get the score from the previous page
        Intent intent = getIntent();
        score_received5 = intent.getIntExtra("score4", 0);
        ...
        // Start the timer
        tick = MediaPlayer.create(WW2_Spelling5.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(WW2_Spelling5.this, R.raw.wrong);
                wrong.start();
        ...
        // Get the text from the text input layout
        ...
        button.setOnClickListener(v -> {
            ...
            if (answer != null) {
                if (answer.equalsIgnoreCase("United States of America")) {

                    // Stop the music
                    correct = MediaPlayer.create(WW2_Spelling5.this, R.raw.correctsound);
                    correct.start();
                    // Add 1 to the score
                    score_received5++;

                    // Display to the textview that the user is correct
                    correctText.setText("Your score is: " + score_received5);
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(WW2_Spelling5.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, WW2_Spelling6.class);
