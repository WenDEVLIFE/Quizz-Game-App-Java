...
public class WW2_Spelling9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ww2_spelling9);
        ...
        // Start the timer
        tick = MediaPlayer.create(WW2_Spelling9.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(WW2_Spelling9.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (answer != null) {
                if (answer.equalsIgnoreCase("Philippines")) {
                    ...
                    // Stop the music
                    correct = MediaPlayer.create(WW2_Spelling9.this, R.raw.correctsound);
                    correct.start();
                    // Add 1 to the score
                    score_received9++;
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(WW2_Spelling9.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, WW2_Spelling10.class);
