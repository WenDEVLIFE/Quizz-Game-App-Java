...
public class MartialLaw_Normal_Quiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_martial_law_normal_quiz2);
        mediaPlayer = MediaPlayer.create(this, R.raw.from_russia_with_love_huma);
        mediaPlayer.start();
        mediaPlayer.setLooping(true);

        Integer score_received1 = getIntent().getIntExtra("score1", 0);
        ...
        // Start the timer
        tick = MediaPlayer.create(MartialLaw_Normal_Quiz2.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(MartialLaw_Normal_Quiz2.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received2++;
                correct = MediaPlayer.create(MartialLaw_Normal_Quiz2.this, R.raw.correctsound);
                correct.start();
                tick.stop();
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(MartialLaw_Normal_Quiz2.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, MartialLaw_Normal_Quiz3.class);
