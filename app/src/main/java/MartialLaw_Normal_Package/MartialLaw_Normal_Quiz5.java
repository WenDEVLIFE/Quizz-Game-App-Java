package MartialLaw_Normal_Package;
...
public class MartialLaw_Normal_Quiz5 extends AppCompatActivity {
    ...
    private   int score_received5= 0;
    private ImageView timerImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_martial_law_normal_quiz5);
        mediaPlayer = MediaPlayer.create(this, R.raw.from_russia_with_love_huma);
        mediaPlayer.start();
        mediaPlayer.setLooping(true);

        Integer score_received4 = getIntent().getIntExtra("score4", 0);
        score_received5 = score_received4;
        ...
        // Start the timer
        tick = MediaPlayer.create(MartialLaw_Normal_Quiz5.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(MartialLaw_Normal_Quiz5.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received5++;
                correct = MediaPlayer.create(MartialLaw_Normal_Quiz5.this, R.raw.correctsound);
                correct.start();
                tick.stop();
                ...
                correctText.setText("Correct answer: Correct you have score " +  score_received5);
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(MartialLaw_Normal_Quiz5.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, TotalScoreMartialNormal.class);
            intentph5.putExtra("score5", score_received5);
