...
public class MartialLaw_Normal_Quiz4 extends AppCompatActivity {
    ...
    private   int score_received4= 0;
    private ImageView timerImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_martial_law_normal_quiz4);
        mediaPlayer = MediaPlayer.create(this, R.raw.from_russia_with_love_huma);
        mediaPlayer.start();
        mediaPlayer.setLooping(true);

        Integer score_received3 = getIntent().getIntExtra("score3", 0);
        ...
        // Start the timer
        tick = MediaPlayer.create(MartialLaw_Normal_Quiz4.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(MartialLaw_Normal_Quiz4.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received4++;
                correct = MediaPlayer.create(MartialLaw_Normal_Quiz4.this, R.raw.correctsound);
                correct.start();
                tick.stop();
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(MartialLaw_Normal_Quiz4.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, MartialLaw_Normal_Quiz5.class);
            intentph5.putExtra("score4", score_received4);
