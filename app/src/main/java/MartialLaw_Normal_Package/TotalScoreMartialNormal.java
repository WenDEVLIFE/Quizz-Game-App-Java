...
public class TotalScoreMartialNormal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_score_martial_normal);
        ...
        button.setOnClickListener(v -> {
            Intent intentph = new Intent(TotalScoreMartialNormal.this, MartialLaw_Normal_Quiz1.class);
        ...
        button1.setOnClickListener(v -> {
            Intent intentmenu = new Intent(TotalScoreMartialNormal.this, Menu.class);
