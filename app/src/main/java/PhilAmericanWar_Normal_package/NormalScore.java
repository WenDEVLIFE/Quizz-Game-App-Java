...
public class NormalScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> {
            Intent intentph = new Intent(NormalScore.this, PH_USA_Normal_Quiz1.class);
        ...
        button1.setOnClickListener(v -> {
            Intent intentmenu = new Intent(NormalScore.this, Menu.class);
