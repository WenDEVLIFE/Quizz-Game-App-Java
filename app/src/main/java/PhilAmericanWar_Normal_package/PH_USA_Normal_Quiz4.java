...
public class PH_USA_Normal_Quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_usa_normal_quiz4);
        timer = findViewById(R.id.textView7);

        correctText = findViewById(R.id.score_result);

        Intent intent = getIntent();
        int score_received3= intent.getIntExtra("score3", 0);
        ...
        // Start the timer
        tick = MediaPlayer.create(PH_USA_Normal_Quiz4.this, R.raw.countdown);
        ...
        countDownTimer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                wrong = MediaPlayer.create(PH_USA_Normal_Quiz4.this, R.raw.wrong);
                wrong.start();
        ...
        button.setOnClickListener(v -> {
            ...
            if (radioButton1.isChecked()) {
                ...
                score_received4++;
                correct = MediaPlayer.create(PH_USA_Normal_Quiz4.this, R.raw.correctsound);
                correct.start();
                tick.stop();
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(PH_USA_Normal_Quiz4.this).create();
        ...
        button1.setOnClickListener(v-> {
            ...
            // Go to the next page
            Intent intentph5 = new Intent(this, PH_USA_Normal_Quiz5.class);
